...
function set-personal-aws-env -d "Set AWS environment variables from keychain"
	set -gx AWS_ACCESS_KEY_ID (keychain-environment-variable PERSONAL_AWS_CLI_KEY)
	set -gx AWS_SECRET_ACCESS_KEY (keychain-environment-variable PERSONAL_AWS_CLI_SECRET)
end
